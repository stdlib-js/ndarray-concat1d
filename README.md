...
```bash
npm install @stdlib/ndarray-concat1d
```
...
[test-image]: https://github.com/stdlib-js/ndarray-concat1d/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/ndarray-concat1d/actions/workflows/test.yml?query=branch:main
